---
title: "QCSP Officers"
permalink: "/qcsp-officers.html"
---

<style>
.orgchart { max-width: 100%; margin-top: 1rem; }
.top-tier { display: flex; justify-content: center; gap: 1.5rem; }
.top-tier .node-wrap { flex: 0 1 220px; }
.connector { position: relative; height: 36px; }
.connector .v-root {
  position: absolute; left: 50%; top: 0; height: 50%; width: 2px;
  background: #d5cbe8; transform: translateX(-1px);
}
.connector .h-line {
  position: absolute; top: 50%; height: 2px; background: #d5cbe8;
}
.connector .v-stub {
  position: absolute; top: 50%; height: 50%; width: 2px;
  background: #d5cbe8; transform: translateX(-1px);
}
.tier { display: flex; gap: 1rem; }
.tier.tier-9 { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; }
.node {
  background: #fff; border: 1px solid #ece8f2; border-radius: 10px;
  padding: 1rem 0.6rem; text-align: center; height: 100%;
}
.node .avatar {
  width: 64px; height: 64px; border-radius: 50%; object-fit: cover;
  margin: 0 auto 0.6rem; display: block; border: 2px solid #f6f3fa;
}
.node .avatar-initials {
  width: 64px; height: 64px; border-radius: 50%;
  margin: 0 auto 0.6rem; display: flex; align-items: center; justify-content: center;
  background: #f6f3fa; color: #6534a0; font-weight: 700; font-size: 1rem;
...
@media (max-width: 767px) {
  .top-tier { flex-wrap: wrap; }
  .tier.tier-9 { grid-template-columns: repeat(2, 1fr); }
  .top-tier .node-wrap { flex: 0 0 47%; margin-bottom: 1rem; }
  .connector { display: none; }
}
</style>

QCSP's officers lead the organization day-to-day, coordinating program development, innovation, operations, partnerships, community affairs, student affairs, and marketing.
...
<div class="connector">
  <div class="v-root"></div>
  <div class="h-line" style="left: 16.67%; width: 66.66%;"></div>
  <div class="v-stub" style="left: 16.67%;"></div>
  <div class="v-stub" style="left: 50%;"></div>
  <div class="v-stub" style="left: 83.33%;"></div>
</div>

<div class="tier tier-9">
  <div class="node-wrap">
    <div class="node">
